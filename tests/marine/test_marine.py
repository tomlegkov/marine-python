...
def test_epan_auto_reset_count(marine_instance: Marine, epan_auto_reset_count: int):
    assert marine_instance._marine.get_epan_auto_reset_count() == epan_auto_reset_count
